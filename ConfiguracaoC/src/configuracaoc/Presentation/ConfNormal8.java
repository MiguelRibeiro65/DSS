 ...
 * @author PedroRibeiro
 */
public class ConfNormal8 extends javax.swing.JFrame {
    
    private ConfiguraFacil cf;
    /**
     * Creates new form ConfNormal8
     */
    public ConfNormal8() {
        initComponents();
    }

    public ConfNormal8(ConfiguraFacil cf){
        initComponents();
        this.cf = cf;
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A sua Configuração foi submetida");

        jLabel3.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        jLabel3.setText("com sucesso!!!");

        menuPrincipalBut.setBackground(new java.awt.Color(114, 187, 83));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addGap(39, 39, 39)
                .addComponent(menuPrincipalBut, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfNormal8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfNormal8().setVisible(true);
            }
        });
    }
